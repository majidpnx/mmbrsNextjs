  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <header className="w-full shadow-sm sticky top-0 z-50 bg-white">
        ...
        <div
          className={`fixed top-0 right-0 h-screen w-full bg-white/95 backdrop-blur-sm z-40 transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
      ...
      <section className="bg-white py-20 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1">
              ...
              <Image src="/hero.png" alt="Phone Mockup" width={3000} height={3000}  />
